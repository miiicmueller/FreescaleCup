...
void TFC_ProcessTerminal();
	...
	#define TERMINAL_OUT_QUEUE		XBEE_SERIAL_OUTGOING_QUEUE //SDA_SERIAL_OUTGOING_QUEUE
	#define TERMINAL_IN_QUEUE		XBEE_SERIAL_INCOMING_QUEUE //SDA_SERIAL_INCOMING_QUEUE
