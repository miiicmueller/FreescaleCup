...
float aFreqMesTabMot1[FILTER_SIZE] = { 0.0 };

float aFreqMesTabMot2[FILTER_SIZE] = { 0.0 };
...
void gCompute_Execute(void) {
	...
	gComputeInterStruct.gCommandeMoteurGauche = (gXbeeInterStruct.aMotorSpeedCons/100)* mMotor1.aDifferential;
	gComputeInterStruct.gCommandeMoteurDroit = (gXbeeInterStruct.aMotorSpeedCons/100) * mMotor2.aDifferential;
