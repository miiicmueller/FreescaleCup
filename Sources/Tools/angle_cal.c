...
#include "Tools/sqrt16.h"
#include "Tools/median.h"
#include "Tools/asin.h"
...
void angle_calculation(void)
    ...
    nv = (signed char) (gInputInterStruct.gAccelResXYZ[0]);
    X_acc = median(nv, &arr_medianas[0]);

    nv = (signed char) (gInputInterStruct.gAccelResXYZ[1]);
    Y_acc = median(nv, &arr_medianas[1]);

    nv = (signed char) (gInputInterStruct.gAccelResXYZ[2]);
    ...
    //Récupération des angle
    gComputeInterStruct.aAccelPlanAngle[0] = xy_angle;
    gComputeInterStruct.aAccelPlanAngle[1] = xz_angle;
    gComputeInterStruct.aAccelPlanAngle[2] = yz_angle;

    gComputeInterStruct.aAccelPlanMagn[0] = xy_mag;
    gComputeInterStruct.aAccelPlanMagn[1] = xz_mag;
    gComputeInterStruct.aAccelPlanMagn[2] = yz_mag;
