...
#define kLengthStartStopMax	20	//longueur max d'un morceau de la ligne de départ/arrivée a trouver (en pixels)
//--
...
void mTrackLine_Correlation(int16_t* tab, uint16_t size, int16_t* thePosition,
    ...
    int32_t aConvultionResultTab[kLINE_SCAN_SIZE + kLINE_PATTERN_SIZE]; // ATTENTION : kLINE_PATTERN_SIZE >= kFINISH_PATTERN_SIZE, sinon il y aura des problème
    ...
    //Attention il faut gérer le dépassement du côté droit
